...
export default function VendorProductFormPage() {
  ...
  const existingProduct =
    isEditMode && typeof params.id === "string"
  ...
  const [formData, setFormData] = React.useState({
    ...
    description: existingProduct
      ? "Premium fashion line item with advanced configuration metrics."
      : "",
  ...
  // FIXED: Consolidated selection modifications inside explicit handlers instead of synchronous useEffect loops
  ...
  return (
    <div className="space-y-8 max-w-6xl mx-auto animate-in fade-in duration-300">
      ...
      <div className="bg-muted/10 border border-border/40 rounded-2xl p-4 flex items-center justify-center select-none shadow-2xs">
        <div className="flex items-center gap-4 max-w-2xl w-full justify-between">
          {[
            { step: 1, label: "Core Details" },
            { step: 2, label: "Sizing Matrix" },
      ...
      <form
        ...
        <div className="lg:col-span-7 bg-card border border-border/60 rounded-2xl p-6 space-y-6 shadow-2xs">
          {currentStep === 1 && (
            <div className="space-y-5 animate-in fade-in duration-200">
              ...
              <div className="pt-4 border-t border-border/40 flex justify-end">
                <button
                  ...
                  <span>Next: Configure Sizes</span>
        ...
        <div className="lg:col-span-5 space-y-4 select-none">
          <div className="bg-card border border-border/60 rounded-2xl p-5 space-y-4 shadow-2xs">
